...
$this->registerJsFile('/js/jquery-1.8.3.min.js',['depends'=>'yii\web\JqueryAsset']);
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$goods->logo.'?imageView2/1/w/500/h/500'?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goods->logo.'?imageView2/1/w/350/h/350'?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$goods->logo.'?imageView2/1/w/350/h/350'?>',largeimage: '<?=$goods->logo.'?imageView2/1/w/500/h/500'?>'}"><img src="<?=$goods->logo.'?imageView2/1/w/300/h/300'?>"></a>
								</li>
                                <?php foreach ($imgs as $img):?>
                                    <li>
                                        <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img.'?imageView2/1/w/350/h/350';?>',largeimage: '<?=$img.'?imageView2/1/w/500/h/500';?>'}"><img src="<?=$img.'?imageView2/1/w/300/h/300';?>"></a>
                                    </li>
                                <?php endforeach;?>
